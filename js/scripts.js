/*-----------------------------------------------------------------------------------
    ...
    Theme Name: HarLabs - One Page Portfolio
   ...
   // Sidemenu toggle
    ...
    wind.on("scroll",function () {
        ...
        if(bodyScroll > 100){
            ...
            logo.attr('src', 'img/logo-harlabs-445x76-black.png');
            darkbg.attr('src', 'img/logo-harlabs-445x76-white.png');
            whitebg.attr('src', 'img/logo-harlabs-445x76-black.png');
            scrollbg.attr('src', 'img/logo-harlabs-445x76-white.png');
            lightbg.attr('src', 'img/logo-harlabs-445x76-black.png');

        }else{
            navbar.removeClass("nav-scroll");
            logo.attr('src', 'img/logo-harlabs-445x76-white.png');
            lightbg.attr('src', 'img/logo-harlabs-445x76-black.png');
            navbloglogo.attr('src', 'img/logo-harlabs-445x76-black.png');
        }
    });
